...
namespace Financ.TesteUnitarios.Domain
{
    public class UnitTestesContasUsuarios
    {
        ...
        {
            Action action = () => new ContasUsuarios(0, 1, "3f2504e0-4f89-11d3-9a0c-0305e82c3301", TiposAcessos.Visualizador, TiposStatus.Ativo);
            action.Should().Throw<ContasUsuariosValidacao>().WithMessage(MensagensBase.ID_IGUAL_MENOR_ZERO);

            action = () => new ContasUsuarios(-3, 1,  "3f2504e0-4f89-11d3-9a0c-0305e82c3301", TiposAcessos.Visualizador, TiposStatus.Ativo);
            action.Should().Throw<ContasUsuariosValidacao>().WithMessage(MensagensBase.ID_IGUAL_MENOR_ZERO);
        }
        ...
        {
            Action action = () => new ContasUsuarios(0,  "3f2504e0-4f89-11d3-9a0c-0305e82c3301", TiposAcessos.Visualizador, TiposStatus.Ativo);
        ...
        {
            Action action = () => new ContasUsuarios(1,  string.Empty, TiposAcessos.Visualizador, TiposStatus.Ativo);
        ...
        public void TipoAcesso_Invalido_GeraDivergencia()
        {
            ...
            Action action = () => new ContasUsuarios(1,  "3f2504e0-4f89-11d3-9a0c-0305e82c3301", acessoInvalido, TiposStatus.Ativo);
        ...
        public void Status_Invalido_GeraDivergencia()
        {
            ...
            Action action = () => new ContasUsuarios(1, "3f2504e0-4f89-11d3-9a0c-0305e82c3301", TiposAcessos.Visualizador, statusInvalido);
        ...
        {
            Action action = () => new ContasUsuarios(1,  "3f2504e0-4f89-11d3-9a0c-0305e82c3301", TiposAcessos.Visualizador, TiposStatus.Ativo);
        ...
        {
            Action action = () => new ContasUsuarios(1, 1, "3f2504e0-4f89-11d3-9a0c-0305e82c3301", TiposAcessos.Administrador, TiposStatus.Ativo);
            action.Should().NotThrow<ContasUsuariosValidacao>();
        }
        ...
        {
            var contaUsuario = new ContasUsuarios(1, 1, "3f2504e0-4f89-11d3-9a0c-0305e82c3301", TiposAcessos.Administrador, TiposStatus.Ativo);

...
namespace Financ.TesteUnitarios.Domain
{
    public class UnitTesteContasUsuarios
    {
        ...
        {
            Action action = () => new ContasUsuario(0, 1, 1, TipoAcesso.Visualizador, Status.Ativo, DateTime.Now);
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.ID_IGUAL_MENOR_ZERO);

            action = () => new ContasUsuario(-3, 1, 1, TipoAcesso.Visualizador, Status.Ativo, DateTime.Now);
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.ID_IGUAL_MENOR_ZERO);
        }
        ...
        {
            Action action = () => new ContasUsuario(0, 1, TipoAcesso.Visualizador, Status.Ativo, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuario(1, 0, TipoAcesso.Visualizador, Status.Ativo, DateTime.Now);
        ...
        {
            var acessoInvalido = (TipoAcesso)999;
            Action action = () => new ContasUsuario(1, 1, acessoInvalido, Status.Ativo, DateTime.Now);
        ...
        public void Status_Invalido_GeraDivergencia()
        {
            ...
            Action action = () => new ContasUsuario(1, 1, TipoAcesso.Visualizador, statusInvalido, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuario(1, 1, TipoAcesso.Visualizador, Status.Ativo, DateTime.Now.AddDays(-1));
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.DATA_REGISTRO_INVALIDA);

            action = () => new ContasUsuario(1, 1, TipoAcesso.Visualizador, Status.Ativo, DateTime.Now.AddDays(1));
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.DATA_REGISTRO_INVALIDA);
        }
        ...
        {
            Action action = () => new ContasUsuario(1, 1, TipoAcesso.Visualizador, Status.Ativo, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuario(1, 1, 1, TipoAcesso.Administrador, Status.Ativo, DateTime.Now);
            action.Should().NotThrow<ValidacaoDominio>();
        }
    }
}

...
namespace Financ.TesteUnitarios.Domain
{
    public class UnitTesteContasUsuarios
    {
        ...
        {
            Action action = () => new ContasUsuarios(0, 1, 1, TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.ID_IGUAL_MENOR_ZERO);

            action = () => new ContasUsuarios(-3, 1, 1, TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.ID_IGUAL_MENOR_ZERO);
        }
        ...
        {
            Action action = () => new ContasUsuarios(0, 1, TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuarios(1, 0, TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
        ...
        public void TipoAcesso_Invalido_GeraDivergencia()
        {
            ...
            Action action = () => new ContasUsuarios(1, 1, acessoInvalido, TiposStatus.Ativo, DateTime.Now);
        ...
        public void Status_Invalido_GeraDivergencia()
        {
            ...
            Action action = () => new ContasUsuarios(1, 1, TiposAcessos.Visualizador, statusInvalido, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuarios(1, 1, TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now.AddDays(-1));
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.DATA_REGISTRO_INVALIDA);

            action = () => new ContasUsuarios(1, 1, TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now.AddDays(1));
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.DATA_REGISTRO_INVALIDA);
        }
        ...
        {
            Action action = () => new ContasUsuarios(1, 1, TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuarios(1, 1, 1, TiposAcessos.Administrador, TiposStatus.Ativo, DateTime.Now);
            action.Should().NotThrow<ValidacaoDominio>();
        }
    }
}

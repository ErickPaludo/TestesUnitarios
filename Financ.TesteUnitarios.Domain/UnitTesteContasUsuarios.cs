...
namespace Financ.TesteUnitarios.Domain
{
    public class UnitTesteContasUsuarios
    {
        ...
        {
            Action action = () => new ContasUsuarios(0, 1,  Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.ID_IGUAL_MENOR_ZERO);

            action = () => new ContasUsuarios(-3, 1,  Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.ID_IGUAL_MENOR_ZERO);
        }
        ...
        {
            Action action = () => new ContasUsuarios(0,  Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuarios(1,  Guid.Empty, TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.IDUSUARIO_VAZIO);
        }
        ...
        public void TipoAcesso_Invalido_GeraDivergencia()
        {
            ...
            Action action = () => new ContasUsuarios(1,  Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), acessoInvalido, TiposStatus.Ativo, DateTime.Now);
        ...
        public void Status_Invalido_GeraDivergencia()
        {
            ...
            Action action = () => new ContasUsuarios(1,  Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), TiposAcessos.Visualizador, statusInvalido, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuarios(1,  Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now.AddDays(-1));
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.DATA_REGISTRO_INVALIDA);

            action = () => new ContasUsuarios(1,  Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now.AddDays(1));
            action.Should().Throw<ValidacaoDominio>().WithMessage(MensagensDominio.DATA_REGISTRO_INVALIDA);
        }
        ...
        {
            Action action = () => new ContasUsuarios(1,  Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), TiposAcessos.Visualizador, TiposStatus.Ativo, DateTime.Now);
        ...
        {
            Action action = () => new ContasUsuarios(1, 1, Guid.Parse("3f2504e0-4f89-11d3-9a0c-0305e82c3301"), TiposAcessos.Administrador, TiposStatus.Ativo, DateTime.Now);
            action.Should().NotThrow<ValidacaoDominio>();
        }
    }
}
